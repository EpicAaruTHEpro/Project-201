...
principle_label=Label(window, text="Principle in $", fg = "black", bg = "grey", font=("Calibri", 12),bd=1)
...
result=Label(result_frame,text="Result display", bg = "grey", font=("Calibri", 12), width=55)
